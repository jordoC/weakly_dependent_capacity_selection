...
[cov_evec cov_eval] = eig(cov_mat);

cov_eval_max = max(diag(cov_eval));
cov_eval_min = min(diag(cov_eval));

mean_max_est = cov_eval_min*sqrt(2*log(num_groups)-2.5-log(2*log(num_groups)-2.5))-0.68*cov_eval_max
